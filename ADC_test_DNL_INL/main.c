...
#define ADC_PIN 26
#define ADC_NUM_SAMPLES 131072
#define ADC_WARMUP_SAMPLES 256
#define SAMPLE_RATE 20000
#define UART_SETTLE_DELAY_MS 3000
#define ADC_BITS 12
...
int main() {
    ...
    printf("# input=ramp_0_to_3v3 channel=%d gpio=%d sample_rate=%d samples=%d adc_bits=%d\r\n",
        ADC_CHANNEL,
        ADC_PIN,
        SAMPLE_RATE,
        ADC_NUM_SAMPLES,
